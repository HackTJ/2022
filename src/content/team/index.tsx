...
const teamData = [
  ...
  },
  {
    ...
    image: "ShreyasMayya.JPG",
  },
  {
    name: "Autin Mitra",
    about:
      "Autin is a senior at TJ who is working on the web redesign, and is excited to be working on the event. He’s competed and thoroughly enjoyed HackTJ for multiple years - ever since HackTJ 6.0. Autin hopes to be able to help put together a cohesive experience for HackTJ attendees and help the event excel.",
    image: "AutinMitra.JPG",
  },
  {
    name: "Simrith Ranjan",
    about:
